	...
	private void btnUpdateRegisterUserAction() {
		try {
			...
			if (jsonObject != null) {
				if (jsonObject.get("codigo") != null && !jsonObject.get("codigo").isJsonNull()) {
					...
					if (codigo == 200) {
						...
						JOptionPane.showMessageDialog(this, "Cadastrado atualizado com sucesso",
								"Operação de Atualizar Cadastro", JOptionPane.INFORMATION_MESSAGE);
						...
						JOptionPane.showMessageDialog(this, "Falha na atualização de cadastro",
								"Operação de Atualizar Cadastro", JOptionPane.ERROR_MESSAGE);
					}
				} else
				...
				JOptionPane.showMessageDialog(this, "JsonObject ta null", "Operação de Atualizar Cadastro",
