...
public class ShowIncidentsLayout extends JFrame {
	...
	private void initComponents() {
		...
		table.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Data", "Rodovia", "Km", "Tipo do incidente" }));
		...
		cbPeriod.setModel(new DefaultComboBoxModel<String>(new String[] { "Manhã - 06:00 ~ 11:59",
				"Tarde - 12:00 ~ 17:59", "Noite - 18:00 ~ 23:59", "Madrugada - 00:00 ~ 05:59" }));
				...
				if (codigo == 200) {
					if (jsonObject.get("codigo") != null && !jsonObject.get("codigo").isJsonNull()) {
						if (jsonObject.get("lista_incidentes").getAsJsonArray().size() == 0) {
							JOptionPane.showMessageDialog(this, "Não foi encontrado incidente",
									"Operação de mostrar incidentes", JOptionPane.ERROR_MESSAGE);
						}
						...
						for (Incident incident2 : incidents) {
							model.addRow(new Object[] { incident2.getDate(), incident2.getHighway(), incident2.getKm(),
					...
					JOptionPane.showMessageDialog(this, "Mostrar incidentes deu errado", "Erro de mostrar incidentes",
							JOptionPane.ERROR_MESSAGE);
				}
			} else {
				JOptionPane.showMessageDialog(this, "JsonObject ta null.", "Erro de mostrar incidentes",
						JOptionPane.ERROR_MESSAGE);
			}
